    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-xl border border-input bg-card px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-accent/10"
          >
            Go home
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "BtechBuddy — Your Smart Exam Companion" },
      {
        name: "description",
        content:
          "Exam-focused B.Tech prep: AKTU notes, PYQs, mock tests and smart study plans in one app.",
      },
